...
export default function HighSchoolSuggestionBoxWebsite() {
  ...
  useEffect(() => {
    const selectors = [
      "[data-page-shell] > div",
      "[data-page-shell] > section",
      "[data-page-shell] section",
      "[data-page-shell] form > *",
      "[data-page-shell] .rounded-3xl",
      ".site-footer",
    ];
    ...
    uniqueItems.forEach((item) => revealObserver.observe(item));
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <main className="mx-auto max-w-6xl px-4 pb-8 pt-20">
        <div key={page} data-page-shell className="motion-page">
        {page === "home" && (
...
function Footer() {
  return (
    <footer className="site-footer mt-8 bg-slate-200/70 px-4 py-8">
